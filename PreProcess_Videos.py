...
#print(resnet3d_model.eval())

"""
#Preparation de la Dataset:

#On doit réorganiser la dataset brute UCF-Crime de la sorte:

#1)Mettre dans un dossier /Anormal tous les dossiers anormaux : Abuse, Arrest, ....Vandalism
#2)Mettre dans un dossier /Normal un dossier /Training_Normal_Videos_Anomaly et mettre toutes les videos 
#normales
#3)Diviser UCF_split en 2 fichiers: un split pour abnormal et un autre pour normal
#-> cela facilite la lecture des videos
"""
...
"""       
video_path = '/Dataset/Anomaly-Videos-Part-1/Anomaly-Videos-Part-1/Arrest/Arrest001_x264.mp4'
parent_dir = '/Users/sofia/Desktop/Master_ISI/Machine learning&IA/Projet_MLA'
extract_features_resnet3d(video_path = parent_dir + video_path, out_dir = parent_dir + '/Features/Anormal/')
"""
...
abnormal_videos_dir = parent_dir + '/Dataset' + '/Abnormal'
normal_videos_dir = parent_dir + '/Dataset' + '/Normal'

#Where the features will be saved
abnormal_features_dir = parent_dir + '/Features/Abnormal/'
...
"""  
TO DO:  
#extracton features peut prendre plusieurs jours avec un CPU
#Essayer d'utiliser librairie OpenCL ou Numba pour utiliser GPU et accélerer calcul
et voir le GPU de Université
"""
